...
class Brainup_Cielo_Model_Dc extends Brainup_Cielo_Model_Abstract
{

    protected $_code  = 'Brainup_Cielo_Dc';
    protected $_formBlockType = 'Brainup_Cielo/form_dc';
    protected $_infoBlockType = 'Brainup_Cielo/info_dc';
	...
	public function validate()
	{
		...
		$availableTypes = Mage::getModel('Brainup_Cielo/dc_types')->getCodes();

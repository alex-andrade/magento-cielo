...
class Brainup_Cielo_Model_WebServiceOrder
{
	...
	function __construct($params)
	{
		...
		$certificatePath 	= (isset($params['caminhoCertificado']) && $params['caminhoCertificado'] != "")	? $params['caminhoCertificado'] 	: Mage::getModuleDir('', 'Brainup_Cielo') . "/ssl/VeriSignClass3PublicPrimaryCertificationAuthority-G5.crt";

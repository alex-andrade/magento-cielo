	function selectCardTypeDc(element)
	{
		...
		$('brainup-cielo-dc-type').value = $(element).getAttribute('ccType');
	...
	function brainupCieloDcMask(event)
	{	
	...
	function brainupSetCieloDcMask(event)
	{
		var field = event.currentTarget;
	...
	function brainupCieloDcNumberKeys(event)
	{	
		var keyCode = ('which' in event) ? event.which : event.keyCode;
	...
	function brainupCieloDcSpecialKeys(event)
	{
		var keyCode = ('which' in event) ? event.which : event.keyCode;
